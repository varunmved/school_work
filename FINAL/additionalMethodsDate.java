...
/*
I wouldn't make this a seperate function, correct? this can just be
right after the scanner function for when the user enters a birthday
*/
    int loc1, loc2;
    String monthStr;
    String dayStr;
...
/*
 ...
 /**
  * @param names Possible monster names
  * @param mIds Possible monster IDs
  * @param it Monster specific items or path items that aren't gear
  * @param p Path to monster
  */
 public Task(String[] names, int[] mIds, BankItem[] it, PathEntity[] p)
 {
  monsterNames = names;
  monsterIds = mIds;
  gearNames = new String[]{};
  pathGearNames = new String[]{};
  path = p;
  items = it;
 }